...
<template>
    ...
    <PublicLayout current="verify">
        ...
        <section class="relative overflow-hidden bg-csc-blue-deep text-white">
            <!--
                The same facade and wash the home page opens with, rather than
                the flat blue this used to be. Someone arrives here from a QR
                code on a piece of paper with no idea what site they have
                landed on, and a plain coloured band is the one backdrop that
                could belong to anybody. The building is the Commission
                identifying itself.

                The seal pattern stays, laid over the photograph: it is the
                motif that says *verification* specifically, and it survives on
                top of the wash at the opacity it already used.
            -->
            ...
            <div class="relative mx-auto max-w-3xl px-4 py-14 text-center sm:px-6 sm:py-16 lg:px-8">
                <span
                    class="verify-stamp mx-auto inline-flex size-16 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/20"
                >
                    <AppIcon name="shield" size="lg" class="text-white" />
                </span>

                <h1 class="verify-rise mt-6 text-3xl font-semibold tracking-tight text-balance sm:text-4xl" style="--delay: 0.08s">
                    Verify a certificate
                </h1>
                <p
                    class="verify-rise mx-auto mt-4 max-w-xl text-base leading-relaxed text-pretty text-white/85"
                    style="--delay: 0.16s"
                >
            ...
            <!--
                The same wave that closes the home page's hero. It is what makes
                the band read as the top of this site rather than as a coloured
                rectangle someone dropped in, and it hands off to the tint below
                instead of cutting to it on a hard line.
            -->
        ...
        <!--
            Tint rather than white. The form and the two explanatory panels are
            white cards, and on a white page they were three borders drawn on
            nothing — the tint is what makes them read as cards at all.
        -->
        <div class="bg-csc-blue-tint px-4 py-12 sm:px-6 sm:py-14 lg:px-8">
            <div class="mx-auto max-w-3xl">
            <!-- The form, lifted onto its own card so it reads as the one task here. -->
            <div
                class="verify-rise mx-auto max-w-xl rounded-2xl border border-csc-line bg-white p-6 shadow-sm sm:p-8"
                style="--delay: 0.24s"
            >
                ...
                <div class="mt-8 border-t border-csc-line pt-6">
                    ...
                    >
                        ...
                        <!--
                            The code line, directly beneath the QR and centred on
                            it. This rule is the single thing the whole diagram
                            exists to point at, so it gets the one attention beat
                            on the page — and only after both callouts have
                            arrived, or it would be competing with them.
                        -->
                        <rect
                            x="20"
                            y="224"
                            ...
                            height="18"
                            rx="4"
                            class="verify-pulse fill-csc-red/10 stroke-csc-red-ink"
                            stroke-width="2.5"
                            style="--delay: 1.15s"
                        />
                        ...
                        <!--
                            ...
                            The callouts arrive one after the other, QR first
                            then the code, which is the order the paragraph above
                            explains them in and the order someone scanning an
                            unfamiliar document needs them.

                            Faded in as whole groups rather than drawn stroke-
                            first: verify-draw commandeers stroke-dasharray to
                            hold the line's length, and these two lines are
                            dashed on purpose — the dash is what marks them as
                            annotation rather than as part of the certificate
                            being drawn. Keeping the dash is worth more than the
                            drawing gesture.
                        -->
                        <g class="verify-rise" style="--delay: 0.45s">
                        ...
                        <g class="verify-rise" style="--delay: 0.7s">
            ...
            -->
            <div
                class="verify-rise mx-auto mt-8 max-w-xl rounded-xl border border-csc-line bg-white px-6 py-5"
                style="--delay: 0.32s"
            >
